...
const OperaCloudExtractor = require('./extractor5.7'); // Updated to use the fixed extractor
        ...
        for (const { type, room } of batch) {
          ...
          for (let attempt = 1; attempt <= 3; attempt++) {
            try {
              ...
              // Updated call to only pass room number and dates, not page object
              const downloadPath = await extractor.downloadReservationCSV(room, '01.01.2024', '31.07.2025');
