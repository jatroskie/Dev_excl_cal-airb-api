// extractor.js - Removed debug console.logs (kept essential warnings), added timing/ETA calculation in processRooms, dynamic timing adjustment: start faster (reduced base waits), but if empty CSV detected, retry with slower waits (increased by 50%)
