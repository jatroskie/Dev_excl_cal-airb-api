// extractor.js - Updated switchHotel: refined searchButton to getByRole('button', { name: 'Search', exact: true }).nth(1) to target the correct one; added debug screenshot
...
class OperaExtractor {
  ...
  async switchHotel(hotelName, hotelCode) {
    ...
    const searchButton = page.getByRole('button', { name: 'Search', exact: true }).nth(1); // Target second match
