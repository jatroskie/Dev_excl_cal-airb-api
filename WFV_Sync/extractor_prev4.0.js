// extractor.js - Slightly faster: reduced baseWait to 4000 headless/2000 debug, reduced other delays by ~20-30%; enhanced monitoring: after save, quick check if CSV contains 'Confirmation Number' header to confirm data (if not and not no-results, retry slow)
