...
document.addEventListener('DOMContentLoaded', function() {
  ...
  try {
    ...
    // Apply left alignment to room labels after rendering
    setTimeout(() => {
      forceLeftAlignment();
    }, 500);
    ...
    fetch('calendar-data.json')
      ...
      .then(data => {
        ...
        setTimeout(() => {
          ...
          // Re-apply left alignment after data loads
          forceLeftAlignment();
        }, 500);
    ...
    const observer = new MutationObserver((mutations) => {
      mutations.forEach((mutation) => {
        if (mutation.type === 'childList') {
          ...
          // Re-apply left alignment after DOM changes
          forceLeftAlignment();
        }
      });
    });
  ...
  function addImprovedStyles() {
    ...
    style.textContent = `
      ...
      .custom-room-label-wrapper {
        ...
        padding-left: 5px !important; /* Add some padding on the left */
      }
