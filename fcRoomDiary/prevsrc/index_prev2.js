...
document.addEventListener('DOMContentLoaded', function() {
  ...
  try {
    calendar = new Calendar(calendarEl, {
      ...
      // Updated resourceLabelContent to include clickable hyperlinks for rooms with URLs
      resourceLabelContent: function(arg) {
        ...
        if (roomUrl && roomUrl !== 'tba' && roomUrl !== 'null') {
          ...
          anchor.textContent = resource.title || `Room ${roomId}`;
          ...
          titleSpan.textContent = resource.title || `Room ${roomId}`;
  ...
  // Add custom CSS for the hyperlinks
