...
# Step 3: Flatten the nested list of rooms (if not already flattened)
flattened_rooms = []
...
for room in flattened_rooms:
    ...
    try:
        ...
        row = {
            ...
            "actType": room.get("extendedProps", {}).get("actType", ""),
            "avePpn": room.get("extendedProps", {}).get("avePpn", 0.0),
            "highPpn": room.get("extendedProps", {}).get("highPpn", 0.0)
        }
