...
// Configuration
// To this (with absolute path):
const config = {
  // Path to your Opera JSON data file - use absolute path to avoid directory issues
  operaDataPath: 'C:\\Users\\jatro\\Dev\\iCal_fill_with_Opera_bookings\\opera_data.json',
  
  // Directory to store generated iCal files - use absolute path
  icalOutputDir: 'C:\\Users\\jatro\\Dev\\iCal_fill_with_Opera_bookings\\ical_files',
...
function processOperaData(data) {
  ...
  if (data.resources && Array.isArray(data.resources)) {
    data.resources.forEach(room => {
      ...
      if (room.extendedProps && room.extendedProps.url) {
        rooms[room.id] = {
          id: room.id,
